...
- [0002](0002-independent-versioning.md) - historical independent-repository versioning (superseded by 0007).
...
- [0007](0007-artifact-versioning.md) - version distributable artifacts, not every repository.
